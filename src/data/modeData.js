export const diningModes = [
  {
    ...
    shortLabel: 'Classic',
    emoji: '🔥',
    badge: "NELLORE'S #1 RATED HIGHWAY DHABA • 4.1 ★",
  ...
  },
  {
    ...
    shortLabel: 'Couple',
    emoji: '💑',
    badge: "ROMANTIC CANDLELIT HIGHWAY DATE • COZY AMBIANCE",
    statusBadge: "🕯️ PRIVATE CORNERS READY • SOFT MUSIC PLAYING",
  ...
  },
  {
    ...
    statusBadge: "❄️ AC FAMILY HALL ACTIVE • HIGH CHAIRS AVAILABLE",
    ...
    perks: [
      ...
      { icon: "IceCream", text: "Kids Special Mild Dishes & Shakes" },
  ...
  },
  {
    ...
    statusBadge: "⚡ FAST SQUAD SERVICE • SIZZLING STARTERS ON FIRE",
    ...
    perks: [
      ...
      { icon: "Coffee", text: "Chilled Mojito Pitchers & Drinks" }
    ],
    features: [
      {
